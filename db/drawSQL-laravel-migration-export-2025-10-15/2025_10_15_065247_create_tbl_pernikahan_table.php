...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('tbl_pernikahan', function (Blueprint $table) {
            $table->integer('id_pernikahan')->primary()->autoIncrement();
            $table->integer('id_jemaat_pria')->nullable();
            $table->foreign('id_jemaat_pria')->references('id_jemaat')->on('tbl_jemaat');
            $table->string('nama_pasangan_pria_luar', 255)->nullable();
            $table->integer('id_jemaat_wanita')->nullable();
            $table->foreign('id_jemaat_wanita')->references('id_jemaat')->on('tbl_jemaat');
    ...
    {
        Schema::dropIfExists('tbl_pernikahan');
    }
};
